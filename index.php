    ...
    <div class="faq-container">
        ...
        <div class="grid">
            ...
            <details name="faq">
                ...
                <p>Apabila terdapat ketidaksesuaian data setelah proses payroll dijalankan, admin dapat menggunakan fitur Manual Adjustment. Koreksi tersebut dapat diterapkan pada periode berjalan atau dikompensasikan pada periode penggajian berikutnya sesuai dengan kebijakan perusahaan.</p>
            </details>
            <details name="faq">
                <summary>Apakah sistem mendukung integrasi dengan metode pembayaran perbankan? <span class="icon"></span></summary>
...
<!-- Footer -->
    <div class="footer">
        <p class="copyright">&copy; 2026 Payroll & Sales. All rights reserved.</p>
    </div>
</div>
</body>
</html>